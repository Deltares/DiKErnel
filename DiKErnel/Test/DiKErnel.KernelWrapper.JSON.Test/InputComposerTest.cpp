...
{
    TEST_CASE("ReadCalculationData_Always_ReturnsCalculationData")
    {
        // Setup
    ...
    TEST_CASE("ReadHydraulicLoads_Always_ReturnsHydraulicLoads")
    {
        // Setup
        const auto filePath = TestUtil::TestDataHelper::GetTestDataPath("DiKErnel.KernelWrapper.Json.Test") / "calculation.json";
    ...
    TEST_CASE("ReadLocations_Always_ReturnsCalculationLocations")
    {
        // Setup
        const auto filePath = TestUtil::TestDataHelper::GetTestDataPath("DiKErnel.KernelWrapper.Json.Test") / "calculation.json";
