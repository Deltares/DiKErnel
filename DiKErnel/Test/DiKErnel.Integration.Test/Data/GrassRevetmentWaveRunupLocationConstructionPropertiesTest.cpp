...
#include "GrassRevetmentWaveRunupLocationConstructionPropertiesMock.h"
...
namespace DiKErnel::Integration::Test
{
    ...
    TEST(GrassRevetmentWaveRunupLocationConstructionPropertiesTest, Constructor_ExpectedValues)
    {
        ...
        // Call
        const GrassRevetmentWaveRunupLocationConstructionPropertiesMock constructionProperties(name, positionZ, topLayerType);
    ...
    TEST(GrassRevetmentWaveRunupLocationConstructionPropertiesTest, GivenConstructionProperties_WhenAllInputSet_ThenExpectedValues)
    {
        ...
        GrassRevetmentWaveRunupLocationConstructionPropertiesMock constructionProperties(name, positionZ, topLayerType);
