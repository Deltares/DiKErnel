...
namespace DiKErnel::Integration::Test
{
    ...
    TEST(GrassRevetmentWaveRunupRayleighLocationConstructionPropertiesTest, Constructor_ExpectedValues)
    {
        ...
        // Call
        const GrassRevetmentWaveRunupRayleighLocationConstructionProperties constructionProperties(name, positionZ, topLayerType);
    ...
    TEST(GrassRevetmentWaveRunupRayleighLocationConstructionPropertiesTest, GivenConstructionProperties_WhenAllInputSet_ThenExpectedValues)
    {
        ...
        const auto criticalCumulativeOverload = 0.4;
        const auto criticalFrontVelocity = 0.5;
        const auto increasedLoadTransitionAlphaM = 0.6;
        const auto reducedStrengthTransitionAlphaS = 0.7;
        const auto averageNumberOfWavesCtm = 0.8;
        const auto representativeWaveRunup2PAru = 0.9;
        const auto representativeWaveRunup2PBru = 1.0;
        const auto representativeWaveRunup2PCru = 1.1;
        const auto waveAngleImpactAbeta = 1.2;
        const auto waveAngleImpactBetamax = 1.3;
        const auto cumulativeOverloadNf = 14;
        const auto frontVelocityCu = 1.5;

        GrassRevetmentWaveRunupRayleighLocationConstructionProperties constructionProperties(name, positionZ, topLayerType);
