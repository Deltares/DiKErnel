...
#pragma region Schematization 1
		...
		[[nodiscard]]
		static unique_ptr<Util::DataResult<ICalculationInput>> CreateCalculationInputForSchematization1Testcase5()
		{
			// Given
			const auto builder = CreateBuilderForSchematization1();
		...
		[[nodiscard]]
		static unique_ptr<Util::DataResult<ICalculationInput>> CreateCalculationInputForSchematization1Testcase6()
		{
			// Given
			const auto builder = CreateBuilderForSchematization1();
		...
		[[nodiscard]]
		static unique_ptr<Util::DataResult<ICalculationInput>> CreateCalculationInputForSchematization1Testcase7()
		{
			// Given
			const auto builder = CreateBuilderForSchematization1();
...
#pragma region Schematization 3
	...
	TEST_F(AsphaltRevetmentWaveImpactCalculationTest, PerformanceTest)
	{
		...
		unsigned item = 1;
		ofstream MyFile("PerformanceTestAsphaltRevetmentWaveImpactCalculationTest.txt", ios::out | ios::trunc);
		...
		MyFile << "Total Calculation time for AsphaltRevetmentWaveImpactCalculationTest is: " << ms_double.count() << " milli seconds" << "\n";
		MyFile << "Average calculation time per AsphaltRevetmentWaveImpactCalculationTest is: " << ms_double.count() / (item * TestDefaults::GetNumberOfTestRuns()) << " milli seconds" << "\n";
		MyFile.close();
	}
