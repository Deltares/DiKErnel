...
namespace DiKErnel::System::Test
{
    ...
    TEST(GrassRevetmentOvertoppingCalculationTest, GivenValidCalculationInput_WhenCalculating_ThenReturnsExpectedCalculationResult)
    {
        // Given
        ...
        constexpr double roughnessCoefficients[] =
        {
            1.0,
            1.0,
            0.75,
        ...
        builder.AddDikeProfileSegment(0.0, -0.1, 5.0, 0.0, &roughnessCoefficients[0]);
        builder.AddDikeProfileSegment(5.0, 0.0, 15.0, 3.0, &roughnessCoefficients[1]);
        builder.AddDikeProfileSegment(15.0, 3.0, 22.0, 3.2, &roughnessCoefficients[2]);
        builder.AddDikeProfileSegment(22.0, 3.2, 30.0, 7.5, &roughnessCoefficients[3]);
        builder.AddDikeProfileSegment(30.0, 7.5, 31.0, 7.6, &roughnessCoefficients[4]);
        builder.AddDikeProfileSegment(31.0, 7.6, 34.0, 7.7, &roughnessCoefficients[5]);
        builder.AddDikeProfileSegment(34.0, 7.7, 35.0, 7.4, &roughnessCoefficients[6]);
        builder.AddDikeProfileSegment(35.0, 7.4, 45.0, 5.0, &roughnessCoefficients[7]);
        builder.AddDikeProfileSegment(45.0, 5.0, 60.0, 0.5, &roughnessCoefficients[8]);
        builder.AddDikeProfileSegment(60.0, 0.5, 70.0, 0.5, &roughnessCoefficients[9]);
