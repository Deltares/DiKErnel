...
{
    TEST(NaturalStoneRevetmentHydraulicLoadInputTest, GivenInput_WhenCreated_ThenExpectedValues)
    {
        // Given & When
        constexpr NaturalStoneRevetmentHydraulicLoadInput input{};
