...
namespace DiKErnel::KernelWrapper::Json::Input::Test
{
    ...
    TEST_F(JsonInputComposerTest, GivenJsonFileWithAllData_WhenGetInputDataFromJson_ThenReturnsResultWithCalculationInputWithExpectedValues)
    {
        ...
        ProfileDataAssertHelper::AssertProfileSegment(-20, -8.95, -10, -6.05, 0, profileSegments.at(1));
        ProfileDataAssertHelper::AssertProfileSegment(-10, -6.05, 0, -3.15, 0, profileSegments.at(2));
        ...
        ProfileDataAssertHelper::AssertProfileSegment(10, -0.25, 15, 1.2, 0.6, profileSegments.at(5));
        ProfileDataAssertHelper::AssertProfileSegment(15, 1.2, 20, 2.65, 0.65, profileSegments.at(6));
        ProfileDataAssertHelper::AssertProfileSegment(20, 2.65, 25, 4.1, 0.7, profileSegments.at(7));
        ProfileDataAssertHelper::AssertProfileSegment(25, 4.1, 30, 5.55, 0.75, profileSegments.at(8));
        ProfileDataAssertHelper::AssertProfileSegment(30, 5.55, 35, 7, 0.8, profileSegments.at(9));
        ProfileDataAssertHelper::AssertProfileSegment(35, 7, 40, 8.45, 0.85, profileSegments.at(10));
        ProfileDataAssertHelper::AssertProfileSegment(40, 8.45, 45, 9.9, 0.9, profileSegments.at(11));
        ProfileDataAssertHelper::AssertProfileSegment(45, 9.9, 50, 11.35, 0.92, profileSegments.at(12));
        ProfileDataAssertHelper::AssertProfileSegment(50, 11.35, 55, 12.8, 0.97, profileSegments.at(13));
        ProfileDataAssertHelper::AssertProfileSegment(55, 12.8, 60, 14.25, 0.99, profileSegments.at(14));
        ProfileDataAssertHelper::AssertProfileSegment(60, 14.25, 65, 15.7, 1.0, profileSegments.at(15));
        ProfileDataAssertHelper::AssertProfileSegment(65, 15.7, 70, 15.8, 1.5, profileSegments.at(16));
        ProfileDataAssertHelper::AssertProfileSegment(70, 15.8, 75, 14.3, 1.5, profileSegments.at(17));
        ProfileDataAssertHelper::AssertProfileSegment(75, 14.3, 80, 12.7, 1.5, profileSegments.at(18));
        ProfileDataAssertHelper::AssertProfileSegment(80, 12.7, 85, 11.4, 1.5, profileSegments.at(19));
        ProfileDataAssertHelper::AssertProfileSegment(85, 11.4, 90, 10, 1.5, profileSegments.at(20));
        ProfileDataAssertHelper::AssertProfileSegment(90, 10, 95, 8.5, 1.5, profileSegments.at(21));
        ProfileDataAssertHelper::AssertProfileSegment(95, 8.5, 100, 7.1, 1.5, profileSegments.at(22));
