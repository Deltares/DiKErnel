...
namespace DiKErnel::KernelWrapper::Json::Input::Test
{
    ...
    TEST_F(JsonInputComposerTest, GivenJsonFile_WhenGetCalculationInputFromJson_ThenReturnICalculationInputWithExpectedValues)
    {
        ...
        NaturalStoneRevetmentLocationDependentInputAssertHelper::AssertMandatoryProperties(0, 0.25, 1.65, 0.3, *locationDependentInputItem1);
        ...
        NaturalStoneRevetmentLocationDependentInputAssertHelper::AssertMandatoryProperties(0.1, 0.3, 1.65, 0.7, *locationDependentInputItem2);
