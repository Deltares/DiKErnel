    ...
    class JsonOutputGrassRevetmentWaveImpactPhysicsLocationData : public JsonOutputPhysicsLocationData
    {
        public:
            explicit JsonOutputGrassRevetmentWaveImpactPhysicsLocationData(
                const Integration::GrassRevetmentWaveImpactLocationDependentOutput& locationDependentOutput);

            [[nodiscard]]
            nlohmann::ordered_json CreateJson() const override;

        private:
            std::vector<Integration::GrassRevetmentWaveImpactTimeDependentOutput*> _timeDependentOutputItems =
                    std::vector<Integration::GrassRevetmentWaveImpactTimeDependentOutput*>();
    };
}
