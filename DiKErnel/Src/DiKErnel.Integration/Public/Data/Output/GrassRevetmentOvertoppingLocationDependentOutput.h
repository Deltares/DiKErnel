...
{
    /*!
     * \brief Location dependent output of a grass revetment overtopping location.
     */
    class GrassRevetmentOvertoppingLocationDependentOutput : public Core::LocationDependentOutput
    {
        public:
            /*!
