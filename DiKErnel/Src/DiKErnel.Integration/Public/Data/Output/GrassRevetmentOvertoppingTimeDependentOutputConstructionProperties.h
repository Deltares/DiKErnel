...
{
    /*!
     * \brief Construction properties to construct grass revetment overtopping time dependent
     *        output.
     */
    class GrassRevetmentOvertoppingTimeDependentOutputConstructionProperties : public Core::TimeDependentOutputConstructionProperties
    {
        public:
            /*!
