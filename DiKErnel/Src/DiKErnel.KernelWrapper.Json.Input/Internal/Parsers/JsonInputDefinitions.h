...
namespace DiKErnel::KernelWrapper::Json::Input
{
    class JsonInputDefinitions
    {
        public:
            ...
            inline static const std::string DIKE_PROFILE_ROUGHNESS_COEFFICIENTS = "ruwheidscoefficienten";
            ...
            inline static const std::string CALCULATION_METHOD_TYPE_GRASS_OVERTOPPING= "grasGolfoverslag";
