...
{
    class JsonInputGrassWaveImpactCalculationDefinitionParser : public JsonInputCalculationDefinitionParser
    {
        public:
            explicit JsonInputGrassWaveImpactCalculationDefinitionParser(
        ...
        private:
            static std::map<JsonInputGrassRevetmentTopLayerType, std::unique_ptr<JsonInputGrassWaveImpactTopLayerDefinitionData>>
