...
namespace DiKErnel::DomainLibrary
{
    ...
    class IAsphaltRevetmentWaveImpactDefaults
    {
        public:
             ...
             *         Unit = [-]
             */
            virtual std::vector<std::tuple<double, double>> GetWidthFactors() const = 0;
             ...
             *         Unit = [-]
             */
            virtual std::vector<std::tuple<double, double>> GetDepthFactors() const = 0;
             ...
             *         Unit = [-]
             */
            virtual std::vector<std::tuple<double, double>> GetImpactFactors() const = 0;
    };
}
