...
{
    /*!
     * \brief Class that contains default values for grass revetment overtopping.
     */
    class GrassRevetmentOvertoppingDefaults
    {
        public:
            /*!
             * \brief Gets the default value of the Cwo coefficient.
             * \return The default value of the Cwo coefficient.
             *         Unit = [-]
             */
            [[nodiscard]]
