...
namespace DiKErnel::Core
{
    ...
    DeprecatedCalculator::DeprecatedCalculator(
        ...
        const function<double(
            ...
            double hydraulicLoadOnNaturalStoneXIb)>& subCalculation)
    ...
    void DeprecatedCalculator::PerformCalculation(
        ...
        const function<double(
            ...
            double hydraulicLoadNs,
            double waveAngleMaximum,
            double hydraulicLoadXIb)>& subCalculation,
        ...
        vector<tuple<double, double>>& outputData)
    {
        ...
        const auto& hydraulicLoad = revetment.GetCalculationMethod().GetHydraulicLoadOnNaturalStone();
        ...
        const auto damage = subCalculation(
            ...
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneAp(),
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneBp(),
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneCp(),
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneNp(),
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneAs(),
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneBs(),
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneCs(),
            hydraulicLoad.GetHydraulicLoadOnNaturalStoneNs(),
            revetment.GetCalculationMethod().GetWaveAngleImpact().GetWaveAngleImpactOnNaturalStoneBetamax(),
