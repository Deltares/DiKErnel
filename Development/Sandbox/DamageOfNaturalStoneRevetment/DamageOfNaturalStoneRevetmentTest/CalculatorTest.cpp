...
namespace DamageOfNaturalStoneRevetmentCalculator
{
    namespace Test
    {
        ...
        {
            // Call
            auto damage = Calculator::CalculateIncrementDamageOfNaturalStoneRevetment(
                slopeAngle,
                relativeDensity,
                thicknessTopLayer,
                spectralWaveHeight,
        ...
        {
            // Call
            auto hydraulicLoadOnNaturalStoneRevetment = Calculator::CalculateHydraulicLoadOnNaturalStoneRevetment(
                slopeAngle,
                spectralWaveHeight,
                spectralWavePeriod);
        ...
        {
            // Call
            auto surfSimilarityParameter = Calculator::CalculateSurfSimilarityParameter(
                slopeAngle,
                spectralWaveHeight,
                spectralWavePeriod);
        ...
        {
            // Call
            auto surfSimilarityParameter = Calculator::CalculateResistanceOfNaturalStoneRevetment(
                relativeDensity,
                thicknessTopLayer);
        ...
        {
            // Call
            auto degradationOfNaturalStoneRevetment = Calculator::CalculateDegradationOfNaturalStoneRevetment(
                exampleReferenceTimeDegradationOfNaturalStoneRevetment,
                spectralWavePeriod);
        ...
        {
            // Call
            auto incrementOfTime = Calculator::CalculateIncrementOfTime(
                initialTime,
                currentTime);

            // Assert
            REQUIRE(incrementOfTime == Approx(36));
        }
        ...
        {
            // Call
            auto degradationOfNaturalStoneRevetment = Calculator::CalculateWaveAngleImpactOnNaturalStoneRevetment(
                waveAngle);
