...
{
    internal static class GrassWaveOvertoppingRayleighLocationDependentInputAssertHelper
    {
        public static void AssertGeneralProperties(double? dikeHeight,
                                                   GrassWaveOvertoppingRayleighLocationDependentInput locationDependentInput)
        {
