...
{
    [TestFixture]
    public class GrassWaveRunupBattjesGroenendijkAnalyticalLocationDependentOutputTest
    {
        [Test]
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var output = new GrassWaveRunupBattjesGroenendijkAnalyticalLocationDependentOutput(timeDependentOutputItems, z);
