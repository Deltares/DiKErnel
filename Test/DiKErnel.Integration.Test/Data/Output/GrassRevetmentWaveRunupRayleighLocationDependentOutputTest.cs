...
{
    [TestFixture]
    public class GrassRevetmentWaveRunupRayleighLocationDependentOutputTest
    {
        
    }

    TEST(GrassRevetmentWaveRunupRayleighLocationDependentOutputTest, Constructor_ExpectedValues)
    {
        // Setup
        ...
        // Call
        const GrassRevetmentWaveRunupRayleighLocationDependentOutput output(move(timeDependentOutputItems), z);
