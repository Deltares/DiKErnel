...
namespace DiKErnel.DomainLibrary.Test.Constants
{
    ...
    internal sealed class GrassWaveRunupBattjesGroenendijkAnalyticalConstantsTests
    {
        ...
        {
            // Call & Assert
            Assert.That(GrassWaveRunupBattjesGroenendijkAnalyticalConstants.K1, Is.EqualTo(2));
        }
        ...
        {
            // Call & Assert
            Assert.That(GrassWaveRunupBattjesGroenendijkAnalyticalConstants.K2, Is.EqualTo(3.6));
        }
    }
}