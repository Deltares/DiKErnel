Feature: GrassWaveRunupBattjesGroenendijkAnalytical2
	...
	Scenario Outline: BM Gras benchmark 14 - Variable input of critical velocity
		...
		Examples: 
			| kritiekeFrontsnelheid | schadegetal            | cumulatieveOverbelastingTijdstap | BM - Gras |
			| 3.5                   | 0.09912791114814828    | 693.895378037038                 | 698.151   |
			| 4                     | 0.08240815773892438    | 576.8571041724706                | 588.395   |
			| 5.5                   | 0.0010160364930812532  | 7.112255451568773                | 7.156     |
			| 6.5                   | 5.35959825332454e-09   | 3.751718777327178e-05            | 0.000     |
			| 8                     | 0.0                    | 0.0                              | 0.000     |
	...
	Scenario Outline: BM Gras benchmark 15 - Variable input of level of interest
		...
		Examples: 
			| positie    | schadegetal            | cumulatieveOverbelastingTijdstap | BM - Gras |
			| 30.5600    | 0.00016098541128284046 | 1.1268978789798831               | 0.000     |
			| 33.6160    | 0.00016098541128284046 | 1.1268978789798831               | 1.134     |
			| 36.6720    | 0.00016098541128278394 | 1.1268978789794877               | 1.134     |
			| 39.7280    | 1.973187114472698e-05  | 0.13812309801308886              | 0.139     |
			| 42.7840    | 1.5496648932714766e-11 | 1.0847654252900337e-07           | 0.000     |
			| 45.8400    | 0.0                    | 0.0                              | 0.000     |
			| 48.8960    | 0.0                    | 0.0                              | 0.000     |
	...
	Scenario Outline: BM Gras benchmark 16 - Variable input of slope of the bottom
		...
		Examples: 
			| tanAvl | schadegetal            | cumulatieveOverbelastingTijdstap | Benchmark for BM - Gras|
			| 0      | 0.0001300542627438877  | 0.9103798392072139               | 0.918                  |
			| 0.004  | 0.00016098541128284046 | 1.1268978789798831               | 1.134                  |
			| 0.04   | 0.0019034054017018846  | 13.323837811913192               | 13.406                 |
	...
	Scenario Outline: BM Gras benchmark 17 - Variable input of water depth
		...
		Examples: 
			| bodemVoorlandZ | schadegetal           | cumulatieveOverbelastingTijdstap | Benchmark for BM - Gras  |
			| 0              | 0.0                   | 0.0                              | 0.000                    |
			| -0.004         | 18.899172206217422    | 132294.20544352196               | 133115.947               |
			| -0.04          | 1.9530600918770284    | 13671.4206431392                 | 13755.272                |
			| -0.1           | 0.8177090570008678    | 5723.963399006075                | 5759.070                 |
			| -0.4           | 0.146449850472942     | 1025.1489533105942               | 1031.437                 |
			| -10            | 0.0030480842313577797 | 21.33658961950446                | 21.453                   |
	...
	Scenario Outline: BM Gras benchmark 18 - Variable input of water depth and critical depth
		...
		Examples: 
			| bodemVoorlandZ | kritiekeCumulatieveOverbelasting | schadegetal        | cumulatieveOverbelastingTijdstap | Benchmark for BM - Gras  |
			| 0              | 1000                             | 0.0                | 0.0                              | 0.000                    |
			| -0.004         | 1000                             | 132.29420544352197 | 132294.20544352196               | 133115.947               |
			| -0.04          | 100                              | 136.714206431392   | 13671.4206431392                 | 13755.272                |
			| -0.1           | 10                               | 572.3963399006075  | 5723.963399006075                | 5759.070                 |
			| -0.4           | 1                                | 1025.1489533105942 | 1025.1489533105942               | 1031.437                 |
			| -10            | 1                                | 21.33658961950446  | 21.33658961950446                | 21.453                   |
