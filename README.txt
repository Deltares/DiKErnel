...
"LICENCE.txt" contains the terms under which DiKErnel can be redistributed and/or modified.
"LICENSE-3RD-PARTY.txt" contains a listing of the terms that are shipped with the third party components used by DiKErnel.