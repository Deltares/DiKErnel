...
namespace DiKErnel.KernelWrapper.Json.Input.Helpers
{
    public class ValidationHelper
    {
        public static bool RegisterValidationIssues(IEnumerable<ValidationIssue> validationIssues)
        {
            var overallValidationSuccessful = true;

            foreach (var validationIssue in validationIssues)
            {
                var individualValidationSuccessful = validationIssue == null || RegisterValidationIssue(validationIssue);
