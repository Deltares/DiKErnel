...
namespace DiKErnel.GrassPerformance
{
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            Action<double> addGrassLocationAction = args[2] switch
            {
                "GrassWaveImpact" => x => builder.AddGrassWaveImpactLocation(
                    new GrassWaveImpactLocationConstructionProperties(x, GrassTopLayerType.OpenSod)),
                "GrassWaveOvertoppingRayleighAnalytical" => x => builder.AddGrassWaveOvertoppingRayleighAnalyticalLocation(
                    new GrassWaveOvertoppingRayleighLocationConstructionProperties(x, GrassTopLayerType.OpenSod)),
                "GrassWaveOvertoppingRayleighDiscrete" => x => builder.AddGrassWaveOvertoppingRayleighDiscreteLocation(
                    new GrassWaveOvertoppingRayleighDiscreteLocationConstructionProperties(x, GrassTopLayerType.OpenSod)),
                "GrassWaveRunupBattjesGroenendijkAnalytical" => x => builder.AddGrassWaveRunupBattjesGroenendijkAnalyticalLocation(
                    new GrassWaveRunupBattjesGroenendijkAnalyticalLocationConstructionProperties(x, GrassTopLayerType.OpenSod)),
                "GrassWaveRunupRayleighDiscrete" => x => builder.AddGrassWaveRunupRayleighDiscreteLocation(
