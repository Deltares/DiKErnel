...
{
    internal static class GrassWaveOvertoppingRayleighAnalyticalLocationDependentInputFactory
    {
        public static GrassWaveOvertoppingRayleighAnalyticalLocationDependentInput CreateLocationDependentInput(
            GrassWaveOvertoppingRayleighLocationConstructionProperties constructionProperties)
        {
            ...
            return new GrassWaveOvertoppingRayleighAnalyticalLocationDependentInput(
