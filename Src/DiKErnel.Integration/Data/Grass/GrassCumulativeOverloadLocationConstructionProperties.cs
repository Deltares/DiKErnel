...
{
    /// <summary>
    /// Construction properties to construct grass cumulative overload location dependent
    /// input.
    /// </summary>
    public abstract class GrassCumulativeOverloadLocationConstructionProperties : LocationConstructionProperties
    {
        /// <inheritdoc/>
        /// <param name="topLayerType">The type of the top layer.</param>
        protected GrassCumulativeOverloadLocationConstructionProperties(double x, GrassTopLayerType topLayerType)
            : base(x)
        {
