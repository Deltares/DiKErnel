...
{
    internal class GrassWaveOvertoppingRayleighAccelerationAlphaA
    {
        public GrassWaveOvertoppingRayleighAccelerationAlphaA(double valueAtCrest, double valueAtInnerSlope)
        {
