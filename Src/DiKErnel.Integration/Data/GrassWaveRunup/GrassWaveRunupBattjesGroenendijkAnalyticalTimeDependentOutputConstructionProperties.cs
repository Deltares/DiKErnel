...
{
    /// <summary>
    /// Construction properties to construct grass wave run-up Battjes-Groenendijk analytical
    /// time dependent output.
    /// </summary>
    public class GrassWaveRunupBattjesGroenendijkAnalyticalTimeDependentOutputConstructionProperties
