...
namespace DiKErnel.Integration.Data.AsphaltWaveImpact
{
    internal class AsphaltWaveImpactLocationDependentInput : LocationDependentInput
    {
        ...
        {
            return new AsphaltWaveImpactLocationDependentOutput(InitialDamage, FailureNumber, timeDependentOutputItems, Z, outerSlope,
                                                                            ...
                                                                            IProfileData profileData)
        {
            ...
            double averageNumberOfWaves = RevetmentFunctions.AverageNumberOfWaves(incrementTime, timeDependentInput.WavePeriodTm10,
