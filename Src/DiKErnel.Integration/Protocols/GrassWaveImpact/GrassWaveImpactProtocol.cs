...
namespace DiKErnel.Integration.Protocols.GrassWaveImpact
{
    internal class GrassWaveImpactProtocol : Protocol
    {
        ...
        public GrassWaveImpactProtocol(GrassRevetmentWaveImpactWaveAngleImpact waveAngleImpact,
                                       double minimumWaveHeightTemax, double maximumWaveHeightTemin,
                                       GrassRevetmentWaveImpactTimeLine timeLine, double upperLimitLoadingAul,
