...
namespace DiKErnel.Integration.Protocols.NaturalStoneWaveImpact
{
    internal class NaturalStoneWaveImpactProtocol : Protocol
    {
        ...
        public NaturalStoneWaveImpactProtocol(double relativeDensity, double thicknessTopLayer,
                                                                            ...
                                                                            IProfileData profileData)
        {
            ...
            if (loadingRevetment)
            {
                ...
                {
                    timeOfFailure = CalculateTimeOfFailure(locationDependentInput.FailureNumber,
        ...
        private double CalculateTimeOfFailure(double failureNumber, double wavePeriodTm10, double beginTime)
        {
