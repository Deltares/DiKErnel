...
namespace DiKErnel.Core.Exceptions
{
    /// <summary>
    /// Exception that can be thrown when time dependent output is invalid.
    /// </summary>
    public class InvalidTimeDependentOutputException : Exception
    {
        /// <summary>
