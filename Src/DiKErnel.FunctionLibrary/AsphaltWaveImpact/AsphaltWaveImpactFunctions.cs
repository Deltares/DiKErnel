...
namespace DiKErnel.FunctionLibrary.AsphaltWaveImpact
{
    ...
    public static class AsphaltWaveImpactFunctions
    {
        ...
        public static double IncrementDamage(AsphaltWaveImpactInput input)
        {
            ...
            {
                (double, double) widthFactor = widthFactorsArray[i];
                                                      ...
                                                      double bendingStressPartial2)
        {
            ...
            {
                (double, double) depthFactor = depthFactorsArray[i];
                                                       ...
                                                       int impactFactorsCount, double bendingStress, double[] impactNumberLookup)
        {
            ...
            for (var i = 0; i < impactFactorsCount; i++)
            {
                double fatigue = Fatigue(input, bendingStress, impactNumberLookup[i]);

                result += impactFactorsArray[i].Item2 * input.AverageNumberOfWaves * fatigue;
            }
